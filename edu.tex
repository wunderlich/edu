...
\begin{macro}{\pdfgrid}[4]{[<included pages>]}{<number of pages>}{<filename>}{[<page width>]}
\begin{macro}{\pdfgrid*}[4]{[<excluded pages>]}{<number of pages>}{<filename>}{[<page width>]}
...
\begin{MacroCode}{class}
\DeclareDocumentCommand{\pdfgrid} { s o m m O{0.445\linewidth} } {
  \IfBooleanTF {#1} {
    \edu_create_grid_exclude:nnnn {#2} {#3} {#4} {#5}
  }{
    ...
    \IfNoValueTF {#2} {
      ...
      \edu_create_grid_include:nnnn {#2} {#3} {#4} {#5}
    }
  }
}
...
\begin{macro*}{\edu_create_grid_include:nnnn}[4]{[<included pages>]}{<number of pages>}{<filename>}{[<page width>]}
\begin{macro*}{\edu_create_grid_exclude:nnnn}[4]{[<excluded pages>]}{<number of pages>}{<filename>}{[<page width>]}
Counters for creating the grid.
\begin{MacroCode}{class}
\cs_new_protected:Npn \edu_create_grid_include:nnnn #1 #2 #3 #4 {
...
\cs_new_protected:Npn \edu_create_grid_exclude:nnnn #1 #2 #3 #4 {
