...
% Colors
\input{src/graphics/define-colourset.tex}
...
\input{src/variables/options.tex}

\input{src/variables/variables.tex}

\input{src/variables/metadata.tex}
...
\input{src/exercises/counters.tex}
...
\input{src/exercises/exe/exe.tex}
\input{src/exercises/exe/subexe.tex}


Die Implementierung der Überschriften für Lösungen erfolgt analog:
\input{src/exercises/exe/solution.tex}
\input{src/exercises/exe/subsolution.tex}
...
\input{src/exercises/multiexe/setup/multiexelabel.tex}
\input{src/exercises/multiexe/setup/item*.tex}


\input{src/exercises/multiexe/multiexe.tex}


\input{src/exercises/multiexe/results/res.tex}
\input{src/exercises/multiexe/results/resr.tex}
\input{src/exercises/multiexe/results/resb.tex}
...
\input{src/exercises/multiexe/multiexelist.tex}


\subsubsection{Aufgabenliste (Horizontale Liste von Teilaufgaben)}

\input{src/exercises/multiexe/multiexelisti.tex}
...
\input{src/exercises/multiexe/multiexearray.tex}

\input{src/exercises/multiexe/bonus.tex}
\input{src/exercises/multiexe/ls.tex}


\subsubsection{Verweise}
\input{src/exercises/references.tex}
