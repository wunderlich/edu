...
\localeDE{\section{Das erste Arbeitsblatt}}
...
\localeDE{
In Abschnitt~\ref{sec:kopfzeile} wurde bereits erörtert, welche Metadaten sinnvollerweise auf einem Arbeitsblatt gesetzt werden sollten. Diese ergänzen wir in der Präambel unseres Arbeitsblattes:
}
...
\localeDE{\subsection{Grafikdateien einfügen}}
...
%
\localeDE{
Insbesondere im Zusammenhang mit der Unterrichtsplanung (s.\,Abschnitt~\ref{sec:unterrichtsplanung}) kann es hilfreich sein, horizontale Linien als Notizen einzufügen ("`Bis hier hin sind wir gekommen."'). Dies kann durch das Makro \Macro\notehr\ (engl. \emph{horizontal rule} -- \emph{horizontale Linie}) getätigt werden:
}
...
\localeDE{
  ...
  \label{sec:unterrichtsplanung}
}



\localeDE{\section{Erscheindungsbild anpassen}}
